...
function Sidebar() {
    return (
        ...
        backdrop-blur-xl border-r border-slate-200/50 dark:border-700/50 flex flex-col relative z-10 '>
            {/* Logo */}
            ...
            <div className='p-4 border-t border-slate-200/50 dark:border-slate-700/50'>
                ...
                dark:bg-slate-800/50 '>
                    <img
                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQPNRo9hZ3RmFOmIc3YfR_aqLwJyQv05UTO6Q&s"
                        alt="user"
                        className='w-10 h-10 rounded-full ring-2 ring-blue-500' />
                    <div className="flex-1 min-w-0">
                        <div className='flex-1 min-w-0'>
                            <p className='text-sm font-medium text-slate-800 dark:text-white truncate'>Alex
                                Johanson</p>
